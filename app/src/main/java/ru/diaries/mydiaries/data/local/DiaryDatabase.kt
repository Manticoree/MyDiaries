...
import ru.diaries.mydiaries.data.local.converters.RoomConverters
...
@Database(
    entities = [DiaryEntryEntity::class, PhotoEntity::class, ExpenseEntity::class, TaskEntity::class, VideoEntity::class, FoodEntity::class, DailyTrackEntity::class, LocationPointEntity::class, WorkoutEntity::class, ExerciseEntity::class, ExerciseSetEntity::class, UserProfileEntity::class, AchievementEntity::class],
    version = 9,
    exportSchema = false
)
